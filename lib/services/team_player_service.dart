...
class TeamPlayerService {
  ...
  static Future<Map<String, dynamic>?> getMyClaimedPlayer(
      String teamId) async {
  ...
  static Future<String> createPlayer({
    ...
    final result = await _supabase.rpc('create_team_player', params: {
      'p_team_id': teamId,
  ...
  static Future<Map<String, dynamic>> claimPlayer({
    ...
    final result = await _supabase.rpc('claim_team_player', params: {
      'p_team_id': teamId,
  ...
  static Future<void> unclaimPlayer({
    ...
    await _supabase.rpc('unclaim_team_player', params: {
      'p_team_id': teamId,
      'p_player_id': playerId,
    });
  }
  ...
  static Future<void> removeCaptainSlot({required String teamId}) async {
    await _supabase.rpc('remove_captain_player_slot', params: {
      'p_team_id': teamId,
    });
  }
